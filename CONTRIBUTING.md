...
This outlines how to propose a change to gtreg. For more detailed info
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("shannonpileggi/gtreg", fork = TRUE)`.
...
of Conduct](https://shannonpileggi.github.io/gtreg/CODE_OF_CONDUCT.md).

...
`tbl_ae_count` counts all AEs (whereas
[`tbl_ae`](https://shannonpileggi.github.io/gtreg/reference/tbl_ae.md)
counts by maximum grade). Thus, `tbl_ae_count` does not provide
percentages as multiple AEs can be counted per subject.

## Example Output

Example 1

![](figures/tbl_ae_count_ex1.png)

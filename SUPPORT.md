...
Thanks for using gtreg! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/shannonpileggi/gtreg/issues/new).
...
requests](https://github.com/shannonpileggi/gtreg/issues) to make sure
